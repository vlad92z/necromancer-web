...
export const ANIMATION = {
  MAP_TILE_REVEAL_DURATION_MS: 350,
  MAP_EVENT_RESOLVE_DELAY_MS: 500,
  MAP_WIZARD_TRAVEL_SPEED_PX_PER_SECOND: 180,
  MAP_WIZARD_FRAME_DURATION_MS: 200,
  COMBAT_MANA_ORB_FLOAT_DURATION_MS: 2500,
  PLAYER_SPEECH_DURATION_MS: 3000,
