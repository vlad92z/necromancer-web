...
export function DeckButton() {
    ...
    const deckTooltip = `You have ${deckRemaining} runes in your draw deck.`;
    ...
    return (
        <button
            type="button"
            onMouseEnter={() => setTooltip(buildTextTooltipCard('deck-tooltip', 'Draw Deck', deckTooltip, deckSvg))}
            onMouseLeave={resetTooltips}
            onFocus={() => setTooltip(buildTextTooltipCard('deck-tooltip', 'Draw Deck', deckTooltip, deckSvg))}
        ...
        >
            ...
            <div className="flex flex-col leading-[1.2] ml-2">
                <span className="text-[0.6rem] font-extrabold uppercase tracking-[0.16em] text-sky-100/70">Deck</span>
