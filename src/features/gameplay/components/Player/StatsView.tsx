    ...
    >
      ...
      <div className="flex flex-col gap-[min(0.8vmin,10px)] w-full">
        <ProgressStatOverlay
          ...
          showFraction
          containerClassName="py-3 px-3.5 rounded-[14px] rounded-[16px] border border-slate-400/35 bg-[linear-gradient(145deg,rgba(16,11,32,0.92)_0%,rgba(6,10,24,0.88)_100%)] shadow-[0_14px_36px_rgba(0,0,0,0.38)] backdrop-blur-[10px] max-w-[640px] w-full"
          trackClassName="h-[10px] bg-[rgba(148,163,184,0.18)]"
          ...
          valueClassColor="text-yellow-400"
        ...
        <ProgressStatOverlay
          ...
          clampToMax
          containerClassName="py-3 px-3.5 rounded-[14px] border border-red-500/30 shadow-[0_12px_28px_rgba(0,0,0,0.42)]"
