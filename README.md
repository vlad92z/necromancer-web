...
### ❄️ Frost (Control)
**Effect**: Freeze one runeforge when placing Frost runes  
...
### 💨 Wind (Mitigation)
**Effect**: Wind runes in floor line cancel other penalties  
**Strategy**: Use as insurance against bad placements  
**Status**: ✅ Implemented
